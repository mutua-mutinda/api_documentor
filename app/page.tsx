...
export default async function ArticlesPage() {
  try {
    ...
    return (
      <>
        <Navbar />
        <div className="mt-8 container mx-auto prose-invert px-4 py-8">
                ...
                {articles.map((article, index) => {
                  ...
                  try {
                    ...
                    return (
                      ...
                      >
                        <p className="text-red-600">
                          💥 Render Error for api documentation guide {index}
                        </p>
    ...
    return (
      <>
        ...
        <div className="container mx-auto px-4 py-8">
          <h1 className="text-4xl font-bold mb-8 text-zinc-200">
            Documentaion guide
          </h1>
          <div className="bg-red-50 border border-red-200 rounded-lg p-4">
            <p className="text-red-600 font-semibold">Error Loading guide</p>
